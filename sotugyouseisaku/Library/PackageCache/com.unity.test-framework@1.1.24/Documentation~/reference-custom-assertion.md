<<<<<<< HEAD:sotugyouseisaku/Library/PackageCache/com.unity.test-framework@1.1.24/Documentation~/reference-custom-assertion.md
# Custom assertion
...
| --------------- | ------------------------------------------------------------ |
| `LogType type`  | A type of log to expect. It can take one of the [LogType enum](https://docs.unity3d.com/ScriptReference/LogType.html) values. |
>>>>>>> master:sotugyouseisaku/Library/PackageCache/com.unity.test-framework@1.1.22/Documentation~/reference-custom-assertion.md
